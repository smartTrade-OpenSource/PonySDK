...
public class BinaryModel {
    ...
    public boolean isBeginKey() {
        return ServerToClientModel.WINDOW_ID.equals(model) || ServerToClientModel.FRAME_ID.equals(model)
                || ServerToClientModel.TYPE_ADD.equals(model) || ServerToClientModel.TYPE_ADD_HANDLER.equals(model)
