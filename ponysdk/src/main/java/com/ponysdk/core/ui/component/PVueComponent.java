...
/**
 * Abstract base class for Vue-based PComponents.
 * <p>
 * PVueComponent extends {@link PComponent} and specifies Vue as the target
 * UI framework. Components extending this class will be rendered using the
 * Vue 3 client-side adapter, which uses {@code createApp} for mounting
 * and reactive props for re-rendering.
 * </p>
 *
 * <h2>Usage Example</h2>
 * <pre>{@code
 ...
 *
 * public class CounterComponent extends PVueComponent<CounterProps> {
 *
 ...
 * @see PComponent
 * @see FrameworkType#VUE
 */
public abstract class PVueComponent<TProps extends Record> extends PComponent<TProps> {

    /**
     * Creates a new PVueComponent with the specified initial props.
     * <p>
     * The component is automatically configured to use the Vue framework type,
     ...
     */
    protected PVueComponent(final TProps initialProps) {
