...
public interface ElementFactory {
    ...
    PDateBox newPDateBox(final PDatePicker picker, final SimpleDateFormat dateFormat, final boolean iskeepDayTimeNeeded);
    ...
    PDateBox newPDateBox(final SimpleDateFormat dateFormat, final boolean iskeepDayTimeNeeded);
