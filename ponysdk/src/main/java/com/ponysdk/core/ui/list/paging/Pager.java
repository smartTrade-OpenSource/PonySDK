...
public class Pager<T> implements IsPWidget {
    ...
    public void process(final int itemCount) {
        ...
        view.setStart(currentPage != 0, 0);
        view.setEnd(currentPage != pageCount - 1, pageCount - 1);

        view.setPrevious(currentPage != 0, currentPage - 1);
        view.setNext(currentPage != pageCount - 1, currentPage + 1);
