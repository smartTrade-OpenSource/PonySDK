...
/**
 * Abstract base class for Svelte-based PComponents.
 * <p>
 * PSvelteComponent extends {@link PComponent} and specifies Svelte as the target
 * UI framework. Components extending this class will be rendered using the
 * Svelte 5 client-side adapter, which uses Svelte's reactive system for mounting
 ...
 *
 * public class CounterComponent extends PSvelteComponent<CounterProps> {
 *
 ...
 * @see PComponent
 * @see FrameworkType#SVELTE
 */
public abstract class PSvelteComponent<TProps extends Record> extends PComponent<TProps> {

    /**
     * Creates a new PSvelteComponent with the specified initial props.
     * <p>
     * The component is automatically configured to use the Svelte framework type,
     ...
     */
    protected PSvelteComponent(final TProps initialProps) {
