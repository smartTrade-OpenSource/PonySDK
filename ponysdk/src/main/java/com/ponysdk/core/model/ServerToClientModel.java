...
public enum ServerToClientModel {
    ...
    VALUE_KEY(ValueTypeModel.INTEGER),
    ...
    POPUP_POSITION(ValueTypeModel.NULL),
    ...
    FIXRATE(ValueTypeModel.INTEGER),
    STOP(ValueTypeModel.NULL),
