...
public enum OperatingSystem {
    ...
    /**
     * First Android 4 device is the Galaxy Nexus phone. Once there are also Tablets with Android 4 we we will
     * have to find a solution to distinguish between mobile phones and tablets.
     */
    ...
    ANDROID3_TABLET(Manufacturer.GOOGLE, OperatingSystem.ANDROID, 30, "Android 3.x Tablet", new String[] { "Android 3" }, null, DeviceType.TABLET, null), // as
                                                                                                                                                          // long
                                                                                                                                                          // as
                                                                                                                                                          // there
                                                                                                                                                          // are
    ...
    /**
     * Symbian OS 7.x versions. Being used by Nokia (3230, 6260, 6600, 6620, 6670, 7610), Panasonic (X700,
     * X800), Samsung (SGH-D720, SGH-D730) and Lenovo (P930).
     */
    ...
    /**
     * BlackBerryOS. The BlackBerryOS exists in different version. How relevant those versions are, is not
     * clear.
     */
    ...
    /*
     * Shortcut to check of an operating system is a mobile device. Left in here for backwards compatibility.
     */
    ...
    /**
     * Checks if the given user-agent string matches to the operating system. Only checks for one specific
     * operating system.
     * 
     * @param agentString
     * @return boolean
    ...
    /**
     * Parses user agent string and returns the best match. Returns OperatingSystem.UNKNOWN if there is no
     * match.
     * 
     * @param agentString
