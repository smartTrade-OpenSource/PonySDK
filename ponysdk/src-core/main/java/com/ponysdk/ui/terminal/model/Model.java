...
public enum Model {
    ...
    WIDGET(23, TypeModel.VARIABLE_SIZE),
    VALUE(24, TypeModel.VARIABLE_SIZE),
    WORD_WRAP(25, TypeModel.VARIABLE_SIZE),
    CLEAR(26, TypeModel.VARIABLE_SIZE),
    CLEAR_ROW(27, TypeModel.VARIABLE_SIZE),
    INSERT_ROW(28, TypeModel.VARIABLE_SIZE),
    CELL_PADDING(29, TypeModel.VARIABLE_SIZE),
    CELL_SPACING(30, TypeModel.VARIABLE_SIZE),
    HORIZONTAL_ALIGNMENT(31, TypeModel.VARIABLE_SIZE),
    VERTICAL_ALIGNMENT(32, TypeModel.VARIABLE_SIZE),
    WIDGET_HIDDEN(33, TypeModel.BOOLEAN_SIZE),
    LEFT(34, TypeModel.VARIABLE_SIZE),
    RIGHT(35, TypeModel.VARIABLE_SIZE),
    WIDTH(36, TypeModel.VARIABLE_SIZE),
    TOP(37, TypeModel.VARIABLE_SIZE),
    BOTTOM(38, TypeModel.VARIABLE_SIZE),
    HEIGHT(39, TypeModel.VARIABLE_SIZE),
    UNIT(40, TypeModel.VARIABLE_SIZE),
    ANIMATE(41, TypeModel.VARIABLE_SIZE),
    NAME(42, TypeModel.VARIABLE_SIZE),
    ANIMATION_DURATION(43, TypeModel.VARIABLE_SIZE),
    OPEN(44, TypeModel.VARIABLE_SIZE),
    IMAGE_URL(45, TypeModel.VARIABLE_SIZE),
    NATIVE(46, TypeModel.VARIABLE_SIZE),
    BIND(47, TypeModel.VARIABLE_SIZE),
    CELL_HORIZONTAL_ALIGNMENT(48, TypeModel.VARIABLE_SIZE),
    CELL(49, TypeModel.VARIABLE_SIZE),
    CELL_VERTICAL_ALIGNMENT(50, TypeModel.VARIABLE_SIZE),
    CELL_HEIGHT(51, TypeModel.VARIABLE_SIZE),
    CELL_WIDTH(52, TypeModel.VARIABLE_SIZE),
    INDEX(53, TypeModel.VARIABLE_SIZE),
    REMOVE(54, TypeModel.BOOLEAN_SIZE),
    COOKIE_EXPIRE(55, TypeModel.VARIABLE_SIZE),
    ADD(56, TypeModel.BOOLEAN_SIZE),
    MONTH(57, TypeModel.VARIABLE_SIZE),
    ANIMATION(58, TypeModel.VARIABLE_SIZE),
    ...
    PICKER(68, TypeModel.VARIABLE_SIZE),
    ROW(69, TypeModel.VARIABLE_SIZE),
    HTMLTABLE_ROW_STYLE(70, TypeModel.BOOLEAN_SIZE),
    ...
    COLUMN(74, TypeModel.VARIABLE_SIZE),
    CELL_FORMATTER_ADD_STYLE_NAME(75, TypeModel.VARIABLE_SIZE),
    HTMLTABLE_CELL_STYLE(76, TypeModel.BOOLEAN_SIZE),
    ...
    HTMLTABLE_COLUMN_STYLE(80, TypeModel.VARIABLE_SIZE),
    ...
    HANDLER_SELECTION_HANDLER(85, TypeModel.VARIABLE_SIZE),
    HANDLER_DATE_VALUE_CHANGE_HANDLER(86, TypeModel.VARIABLE_SIZE),
    HANDLER_BOOLEAN_VALUE_CHANGE_HANDLER(87, TypeModel.VARIABLE_SIZE),
    ...
    HANDLER_KEY_SHOW_RANGE(93, TypeModel.VARIABLE_SIZE),
    POPUP_CAPTION(94, TypeModel.VARIABLE_SIZE),
    WIDGET_VISIBLE(95, TypeModel.VARIABLE_SIZE),
    ...
    HANDLER_CHANGE_HANDLER(102, TypeModel.VARIABLE_SIZE),
    ITEM_INSERTED(103, TypeModel.VARIABLE_SIZE),
    ITEM_TEXT(104, TypeModel.VARIABLE_SIZE),
    ITEM_UPDATED(105, TypeModel.VARIABLE_SIZE),
    ITEM_REMOVED(106, TypeModel.VARIABLE_SIZE),
    SELECTED_INDEX(107, TypeModel.VARIABLE_SIZE),
    SELECTED(108, TypeModel.BOOLEAN_SIZE),
    MULTISELECT(109, TypeModel.VARIABLE_SIZE),
    VISIBLE_ITEM_COUNT(110, TypeModel.VARIABLE_SIZE),
    ITEM_ADD(111, TypeModel.VARIABLE_SIZE),
    ITEM_GROUP(112, TypeModel.VARIABLE_SIZE),
    POPUP_AUTO_HIDE(113, TypeModel.BOOLEAN_SIZE),
    POPUP_MODAL(114, TypeModel.VARIABLE_SIZE),
    POPUP_GLASS_ENABLED(115, TypeModel.VARIABLE_SIZE),
    POPUP_DRAGGABLE(116, TypeModel.VARIABLE_SIZE),
    POPUP_CENTER(117, TypeModel.VARIABLE_SIZE),
    POPUP_SHOW(118, TypeModel.VARIABLE_SIZE),
    POPUP_HIDE(119, TypeModel.VARIABLE_SIZE),
    POPUP_GLASS_STYLE_NAME(120, TypeModel.VARIABLE_SIZE),
    POPUP_POSITION(121, TypeModel.VARIABLE_SIZE),
    POPUP_POSITION_LEFT(122, TypeModel.VARIABLE_SIZE),
    POPUP_POSITION_TOP(123, TypeModel.VARIABLE_SIZE),
    HANDLER_POPUP_POSITION_CALLBACK(124, TypeModel.VARIABLE_SIZE),
    IMAGE(125, TypeModel.VARIABLE_SIZE),
    FIXDELAY(126, TypeModel.VARIABLE_SIZE),
    PINGDELAY(127, TypeModel.VARIABLE_SIZE),
    DISCLOSURE_PANEL_OPEN_IMG(128, TypeModel.VARIABLE_SIZE),
    DISCLOSURE_PANEL_CLOSE_IMG(129, TypeModel.VARIABLE_SIZE),
    MIN_SIZE(130, TypeModel.VARIABLE_SIZE),
    SNAP_CLOSED_SIZE(131, TypeModel.VARIABLE_SIZE),
    TOGGLE_DISPLAY_ALLOWED(132, TypeModel.BOOLEAN_SIZE),
    HANDLER_RESIZE_HANDLER(133, TypeModel.VARIABLE_SIZE),
    HANDLER_COMMAND(134, TypeModel.VARIABLE_SIZE),
    CREATE_LINK(135, TypeModel.VARIABLE_SIZE),
    INSERT_HORIZONTAL_RULE(136, TypeModel.VARIABLE_SIZE),
    INSERT_HTML(137, TypeModel.VARIABLE_SIZE),
    ORDERED(138, TypeModel.VARIABLE_SIZE),
    UNORDERED(139, TypeModel.VARIABLE_SIZE),
    ...
    TOGGLE_BOLD(145, TypeModel.VARIABLE_SIZE),
    TOGGLE_ITALIC(146, TypeModel.VARIABLE_SIZE),
    TOGGLE_SUBSCRIPT(147, TypeModel.VARIABLE_SIZE),
    TOGGLE_UNDERLINE(148, TypeModel.VARIABLE_SIZE),
    LEFT_INDENT(149, TypeModel.VARIABLE_SIZE),
    REDO(150, TypeModel.VARIABLE_SIZE),
    REMOVE_FORMAT(151, TypeModel.VARIABLE_SIZE),
    REMOVE_LINK(152, TypeModel.VARIABLE_SIZE),
    TOGGLE_RIGHT_INDENT(153, TypeModel.VARIABLE_SIZE),
    SELECT_ALL(154, TypeModel.VARIABLE_SIZE),
    ...
    SIZE(169, TypeModel.VARIABLE_SIZE),
    WIDGET_SIZE(170, TypeModel.VARIABLE_SIZE),
    ...
    END_OF_PROCESSING(178, TypeModel.BOOLEAN_SIZE),
    ...
    IMAGE_TOP(183, TypeModel.VARIABLE_SIZE),
    IMAGE_LEFT(184, TypeModel.VARIABLE_SIZE),
    HISTORY_TOKEN(185, TypeModel.VARIABLE_SIZE),
    HISTORY_FIRE_EVENTS(186, TypeModel.BOOLEAN_SIZE),
    APPLICATION_INSTRUCTIONS(187, TypeModel.NULL_SIZE),
    APPLICATION_ERRORS(188, TypeModel.VARIABLE_SIZE),
    FILE_NAME(189, TypeModel.VARIABLE_SIZE),
    HANDLER_SUBMIT_COMPLETE_HANDLER(190, TypeModel.VARIABLE_SIZE),
    LOADING_ON_REQUEST(191, TypeModel.VARIABLE_SIZE),
    ...
    HANDLER_KEY(208, TypeModel.VARIABLE_SIZE),
    HANDLER_KEY_COMMAND(209, TypeModel.NULL_SIZE),
    ...
    CALLBACK(220, TypeModel.BOOLEAN_SIZE),
    ...
    HANDLER_KEY_SCHEDULER(217, TypeModel.VARIABLE_SIZE),
    HANDLER_KEY_RESIZE_HANDLER(226, TypeModel.VARIABLE_SIZE),
    DATE_FORMAT(239, TypeModel.VARIABLE_SIZE),
    TEXTBOX_ID(228, TypeModel.VARIABLE_SIZE),
    WIDGET_FONT_SIZE(240, TypeModel.VARIABLE_SIZE),
    CLEAR_INNER_TEXT(238, TypeModel.VARIABLE_SIZE),
    DATA(235, TypeModel.VARIABLE_SIZE),
    POLL(215, TypeModel.VARIABLE_SIZE),
    KEY(206, TypeModel.VARIABLE_SIZE),
    COOKIES(205, TypeModel.VARIABLE_SIZE),
    APPLICATION_PING(164, TypeModel.VARIABLE_SIZE),
    REPAINT(248, TypeModel.VARIABLE_SIZE);
