...
public enum Model {
    ...
    POPUP_CENTER(117, TypeModel.NULL_SIZE),
    POPUP_SHOW(118, TypeModel.NULL_SIZE),
    POPUP_HIDE(119, TypeModel.NULL_SIZE),
    ...
    HANDLER_POPUP_POSITION_CALLBACK(124, TypeModel.NULL_SIZE),
    FIXDELAY(126, TypeModel.INTEGER_SIZE),
    ...
    START_DATE(251, TypeModel.VARIABLE_SIZE),
    END_DATE(252, TypeModel.VARIABLE_SIZE),
