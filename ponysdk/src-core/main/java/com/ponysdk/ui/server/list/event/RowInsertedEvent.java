...
public class RowInsertedEvent extends SystemEvent<RowInsertedHandler> {
    ...
    public RowInsertedEvent(Object sourceComponent, int row, int insertedRowCount) {
        super(sourceComponent);
    ...
    @Override
    protected void dispatch(RowInsertedHandler handler) {
        handler.onRowInserted(this);
    }

    @Override
    public Type<RowInsertedHandler> getAssociatedType() {
        return TYPE;
    }
