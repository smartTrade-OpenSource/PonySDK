...
/**
 * <p>
 * A {@link PPopupPanel} that wraps its content in a 3x3 grid, which allows users to add rounded corners.
 * </p>
 * <h3>Setting the Size:</h3>
 * <p>
 * If you set the width or height of the {@link PDecoratedPopupPanel}, you need to set the height and width of
 * the middleCenter cell to 100% so that the middleCenter cell takes up all of the available space. If you do
 * not set the width and height of the {@link PDecoratedPopupPanel}, it will wrap its contents tightly.
 * </p>
 * 
 * <pre>
