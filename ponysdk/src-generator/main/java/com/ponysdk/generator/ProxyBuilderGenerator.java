...
public class ProxyBuilderGenerator extends BaseGenerator {
    ...
    public void generate() throws Exception {
        final ClassWriter classWriter = new ClassWriter(getSrcGeneratedDirectory(), "com.ponysdk.service", "ProxyBuilder");
        ...
        for (final Root root : domains) {
            ...
            classWriter.addLine(GeneratorHelper.getRemoteServiceImplFullClassName(domain) + ".getInstance().setService(context.getBean(" + GeneratorHelper.getServiceFullClassName(domain)
                    + ".class));");
