...
/**
 * Template-based counter component demonstrating PTemplateComponent.
 * Uses HTML template defined on the client side.
 */
public class TemplateCounterComponent extends PTemplateComponent<CounterProps> {

    private static final Logger log = LoggerFactory.getLogger(TemplateCounterComponent.class);

    public TemplateCounterComponent(final String label, final int initialCount, final String color) {
    ...
    public void increment() {
        ...
        log.info("Template counter incremented to {}", current.count() + 1);
    }
