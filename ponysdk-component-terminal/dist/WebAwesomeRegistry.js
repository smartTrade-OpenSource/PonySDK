 ...
 * ```
 */
export function registerWebAwesomeComponents(terminal, container) {
 ...
 * ```
 */
export async function ensureWebAwesomeComponentDefined(tagName) {
